...
public class CharacterCreateAnimationControl : MonoBehaviour
{
	...
	public void playAttack(string id)
	{
		...
		base.GetComponent<Animation>().Play(currentAnimation);
	}
	...
	public void toStand()
	{
		...
		base.GetComponent<Animation>().CrossFade(currentAnimation, 0.1f);
		timeElapsed = 0f;
	}
	...
	private void Update()
	{
		...
		else if (base.GetComponent<Animation>()[currentAnimation].normalizedTime >= 1f)
		{
