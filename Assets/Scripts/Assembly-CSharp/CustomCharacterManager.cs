...
public class CustomCharacterManager : MonoBehaviour
{
	...
	public void OnHairBChange(float value)
	{
		...
		{
			setup.myCostume.hair_color = new Color(setup.part_hair.GetComponent<Renderer>().material.color.r, setup.part_hair.GetComponent<Renderer>().material.color.g, value);
			setHairColor();
		}
	}
	...
	public void OnHairGChange(float value)
	{
		...
		{
			setup.myCostume.hair_color = new Color(setup.part_hair.GetComponent<Renderer>().material.color.r, value, setup.part_hair.GetComponent<Renderer>().material.color.b);
			setHairColor();
		}
	}
	...
	public void OnHairRChange(float value)
	{
		if (setup.myCostume != null && setup.part_hair != null)
		{
			setup.myCostume.hair_color = new Color(value, setup.part_hair.GetComponent<Renderer>().material.color.g, setup.part_hair.GetComponent<Renderer>().material.color.b);
			setHairColor();
		}
	}
	...
	private void setHairColor()
	{
		...
		{
			setup.part_hair.GetComponent<Renderer>().material.color = setup.myCostume.hair_color;
		}
		if (setup.part_hair_1 != null)
		{
			setup.part_hair_1.GetComponent<Renderer>().material.color = setup.myCostume.hair_color;
		}
	}
