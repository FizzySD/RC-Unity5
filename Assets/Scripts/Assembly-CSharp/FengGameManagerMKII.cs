...
internal class FengGameManagerMKII : Photon.MonoBehaviour
{
	...
	private void customlevelclientE(string[] content, bool renewHash)
	{
		...
		for (int i = 0; i < content.Length; i++)
		{
			...
			if (array[0].StartsWith("custom"))
			{
				...
				gameObject = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset(array[1]), new Vector3(Convert.ToSingle(array[12]), Convert.ToSingle(array[13]), Convert.ToSingle(array[14])), new Quaternion(Convert.ToSingle(array[15]), Convert.ToSingle(array[16]), Convert.ToSingle(array[17]), Convert.ToSingle(array[18])));
				if (array[2] != "default")
				{
					...
					else
					{
						...
						{
							renderer2.material = (Material)RCassets.LoadAsset(array[2]);
							if (Convert.ToSingle(array[10]) != 1f || Convert.ToSingle(array[11]) != 1f)
							{
			...
			else if (array[0].StartsWith("base"))
			{
				...
				if (array[2] != "default")
				{
					if (array[2].StartsWith("transparent"))
					{
						...
						{
							renderer3.material = (Material)RCassets.LoadAsset("transparent");
							if (Convert.ToSingle(array[10]) != 1f || Convert.ToSingle(array[11]) != 1f)
							{
					...
					else
					{
						...
						foreach (Renderer renderer4 in componentsInChildren5)
						{
							...
							renderer4.material = (Material)RCassets.LoadAsset(array[2]);
							if (Convert.ToSingle(array[10]) != 1f || Convert.ToSingle(array[11]) != 1f)
							{
			...
			else if (array[0].StartsWith("misc"))
			{
				...
				{
					GameObject gameObject = null;
					gameObject = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset(array[1]), new Vector3(Convert.ToSingle(array[5]), Convert.ToSingle(array[6]), Convert.ToSingle(array[7])), new Quaternion(Convert.ToSingle(array[8]), Convert.ToSingle(array[9]), Convert.ToSingle(array[10]), Convert.ToSingle(array[11])));
				...
				else if (array[1].StartsWith("region") && PhotonNetwork.isMasterClient)
				{
					...
					{
						GameObject gameObject2 = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset("region"));
	...
	private void loadskin()
	{
		...
		else
		{
			...
			foreach (GameObject gameObject in array2)
			{
				...
				else if (gameObject.name == "Cube_001" && gameObject.transform.parent.gameObject.tag != "player" && gameObject.GetComponent<Renderer>() != null)
				{
					groundList.Add(gameObject);
					gameObject.GetComponent<Renderer>().material.mainTexture = ((Material)RCassets.LoadAsset("grass")).mainTexture;
				}
			}
			if (!PhotonNetwork.isMasterClient)
			{
		...
		else
		{
			...
			if ((int)settingsOld[64] >= 100)
			{
						...
						for (int j = 0; j < array3.Length; j++)
						{
							...
							if (array4[0].StartsWith("custom") || array4[0].StartsWith("base") || array4[0].StartsWith("photon") || array4[0].StartsWith("spawnpoint") || array4[0].StartsWith("misc") || array4[0].StartsWith("racing"))
							{
								...
								else if (array4[0].StartsWith("misc"))
								{
									...
									{
										gameObject2 = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset("barrierEditor"), new Vector3(Convert.ToSingle(array4[5]), Convert.ToSingle(array4[6]), Convert.ToSingle(array4[7])), new Quaternion(Convert.ToSingle(array4[8]), Convert.ToSingle(array4[9]), Convert.ToSingle(array4[10]), Convert.ToSingle(array4[11])));
									}
									else if (array4[1].StartsWith("region"))
									{
										gameObject2 = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset("regionEditor"));
									...
									{
										gameObject2 = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset("racingStart"), new Vector3(Convert.ToSingle(array4[5]), Convert.ToSingle(array4[6]), Convert.ToSingle(array4[7])), new Quaternion(Convert.ToSingle(array4[8]), Convert.ToSingle(array4[9]), Convert.ToSingle(array4[10]), Convert.ToSingle(array4[11])));
									}
									else if (array4[1].StartsWith("racingEnd"))
									{
										gameObject2 = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset("racingEnd"), new Vector3(Convert.ToSingle(array4[5]), Convert.ToSingle(array4[6]), Convert.ToSingle(array4[7])), new Quaternion(Convert.ToSingle(array4[8]), Convert.ToSingle(array4[9]), Convert.ToSingle(array4[10]), Convert.ToSingle(array4[11])));
									}
								}
								else if (array4[0].StartsWith("racing"))
								{
									gameObject2 = (GameObject)UnityEngine.Object.Instantiate((GameObject)RCassets.LoadAsset(array4[1]), new Vector3(Convert.ToSingle(array4[5]), Convert.ToSingle(array4[6]), Convert.ToSingle(array4[7])), new Quaternion(Convert.ToSingle(array4[8]), Convert.ToSingle(array4[9]), Convert.ToSingle(array4[10]), Convert.ToSingle(array4[11])));
								}
								if (array4[2] != "default" && (array4[0].StartsWith("custom") || (array4[0].StartsWith("base") && array4.Length > 15) || (array4[0].StartsWith("photon") && array4.Length > 15)))
								{
									...
									foreach (Renderer renderer in componentsInChildren)
									{
										...
										{
											renderer.material = (Material)RCassets.LoadAsset(array4[2]);
				...
				if ((int)settingsOld[64] == 101)
				{
					...
					{
						flag = true;
						GameObject original = (GameObject)RCassets.LoadAsset("CannonWallProp");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original);
					...
					{
						flag = true;
						GameObject original = (GameObject)RCassets.LoadAsset("CannonGroundProp");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original);
					...
					else if (GUI.Button(new Rect(num + 27f, 344f, 64f, 60f), "Titan"))
					{
						flag = true;
						flag2 = true;
						GameObject original = (GameObject)RCassets.LoadAsset("titan");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original);
					...
					else if (GUI.Button(new Rect(num + 118f, 344f, 64f, 60f), "Player \nCyan"))
					{
						flag = true;
						flag2 = true;
						GameObject original = (GameObject)RCassets.LoadAsset("playerC");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original);
					...
					else if (GUI.Button(new Rect(num + 209f, 344f, 64f, 60f), "Player \nMagenta"))
					{
						flag = true;
						flag2 = true;
						GameObject original = (GameObject)RCassets.LoadAsset("playerM");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original);
				...
				else if ((int)settingsOld[64] == 107)
				{
					...
					if (GUI.Button(new Rect(num + 30f, 159f, 64f, 30f), "Barrier"))
					{
						flag = true;
						flag2 = true;
						GameObject original2 = (GameObject)RCassets.LoadAsset("barrierEditor");
					...
					else if (GUI.Button(new Rect(num + 30f, 268f, 64f, 30f), "Region"))
					{
						...
						flag = true;
						flag2 = true;
						GameObject original2 = (GameObject)RCassets.LoadAsset("regionEditor");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original2);
						GameObject gameObject3 = (GameObject)UnityEngine.Object.Instantiate(Resources.Load("UI/LabelNameOverHead"));
						gameObject3.name = "RegionLabel";
				...
				else if ((int)settingsOld[64] == 105)
				{
					...
					if (GUI.Button(new Rect(num + 7.8f, 179f, 64f, 30f), "Titan"))
					{
						...
						flag = true;
						flag2 = true;
						GameObject original3 = (GameObject)RCassets.LoadAsset("spawnTitan");
					...
					else if (GUI.Button(new Rect(num + 79.6f, 179f, 64f, 30f), "Aberrant"))
					{
						...
						flag = true;
						flag2 = true;
						GameObject original3 = (GameObject)RCassets.LoadAsset("spawnAbnormal");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original3);
						int num14 = (int)settingsOld[84];
					...
					else if (GUI.Button(new Rect(num + 151.4f, 179f, 64f, 30f), "Jumper"))
					{
						...
						flag = true;
						flag2 = true;
						GameObject original3 = (GameObject)RCassets.LoadAsset("spawnJumper");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original3);
						int num14 = (int)settingsOld[84];
					...
					else if (GUI.Button(new Rect(num + 223.2f, 179f, 64f, 30f), "Crawler"))
					{
						...
						flag = true;
						flag2 = true;
						GameObject original3 = (GameObject)RCassets.LoadAsset("spawnCrawler");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original3);
						int num14 = (int)settingsOld[84];
					...
					else if (GUI.Button(new Rect(num + 7.8f, 293f, 64f, 30f), "Punk"))
					{
						...
						flag = true;
						flag2 = true;
						GameObject original3 = (GameObject)RCassets.LoadAsset("spawnPunk");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original3);
						int num14 = (int)settingsOld[84];
					...
					else if (GUI.Button(new Rect(num + 79.6f, 293f, 64f, 30f), "Annie"))
					{
						...
						flag = true;
						flag2 = true;
						GameObject original3 = (GameObject)RCassets.LoadAsset("spawnAnnie");
						selectedObj = (GameObject)UnityEngine.Object.Instantiate(original3);
						int num14 = (int)settingsOld[84];
				...
				else if ((int)settingsOld[64] == 102)
				{
					...
					for (int j = 0; j < array8.Length; j++)
					{
						...
						{
							flag = true;
							GameObject original2 = (GameObject)RCassets.LoadAsset(array8[j]);
							selectedObj = (GameObject)UnityEngine.Object.Instantiate(original2);
				...
				else if ((int)settingsOld[64] == 103)
				{
					...
					for (int j = 0; j < array8.Length; j++)
					{
						...
						{
							flag = true;
							GameObject original4 = (GameObject)RCassets.LoadAsset(array8[j]);
					...
					if ((string)settingsOld[69] != "default")
					{
						...
						else
						{
							...
							foreach (Renderer renderer3 in componentsInChildren4)
							{
								...
								{
									renderer3.material = (Material)RCassets.LoadAsset((string)settingsOld[69]);
	...
	public Texture2D RCLoadTexture(string tex)
	{
		...
		Texture2D texture2D = (Texture2D)RCassets.LoadAsset(tex);
