...
public class HERO_SETUP : MonoBehaviour
{
	...
	public void create3DMG()
	{
		...
		if (myCostume.mesh_3dmg.Length > 0)
		{
			...
			part_3dmg.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume._3dmg_texture];
		}
		if (myCostume.mesh_3dmg_belt.Length > 0)
		{
			part_3dmg_belt = GenerateCloth(reference, "Character/" + myCostume.mesh_3dmg_belt);
			part_3dmg_belt.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume._3dmg_texture];
		}
		if (myCostume.mesh_3dmg_gas_l.Length > 0)
		{
			...
			part_3dmg_gas_l.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume._3dmg_texture];
		}
		if (myCostume.mesh_3dmg_gas_r.Length > 0)
		{
			...
			part_3dmg_gas_r.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume._3dmg_texture];
		}
		if (myCostume.weapon_l_mesh.Length > 0)
		{
			...
			part_blade_l.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume._3dmg_texture];
		...
		part_blade_r.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume._3dmg_texture];
	...
	public void createHair2()
	{
		...
		if (myCostume.hair_mesh != string.Empty)
		{
			...
			part_hair.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.hairInfo.texture];
			part_hair.GetComponent<Renderer>().material.color = myCostume.hair_color;
		}
	...
	public void createHead2()
	{
		...
		part_head.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.skin_texture];
		part_chest.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.skin_texture];
	}
	...
	public void createLeftArm()
	{
		...
		if (myCostume.arm_l_mesh.Length > 0)
		{
			...
			part_arm_l.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.body_texture];
		}
		...
		if (myCostume.hand_l_mesh.Length > 0)
		{
			...
			part_hand_l.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.skin_texture];
		}
	}

	public void createLowerBody()
	{
		part_leg.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.body_texture];
	}
	...
	public void createRightArm()
	{
		...
		if (myCostume.arm_r_mesh.Length > 0)
		{
			...
			part_arm_r.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.body_texture];
		}
		...
		if (myCostume.hand_r_mesh.Length > 0)
		{
			...
			part_hand_r.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.skin_texture];
		}
	}
	...
	public void createUpperBody2()
	{
		...
		if (myCostume.part_chest_object_mesh.Length > 0)
		{
			...
			part_chest_1.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.part_chest_object_texture];
		}
		if (myCostume.part_chest_1_object_mesh.Length > 0)
		{
			...
			part_chest_2.transform.parent = base.transform.Find("Amarture/Controller_Body/hip/spine/chest").transform;
			part_chest_2.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.part_chest_1_object_texture];
		}
		...
		if (myCostume.body_mesh.Length > 0)
		{
			...
			part_upper_body.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.body_texture];
		}
		if (myCostume.brand1_mesh.Length > 0)
		{
			part_brand_1 = GenerateCloth(reference, "Character/" + myCostume.brand1_mesh);
			part_brand_1.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.brand_texture];
		}
		if (myCostume.brand2_mesh.Length > 0)
		{
			part_brand_2 = GenerateCloth(reference, "Character/" + myCostume.brand2_mesh);
			part_brand_2.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.brand_texture];
		}
		if (myCostume.brand3_mesh.Length > 0)
		{
			part_brand_3 = GenerateCloth(reference, "Character/" + myCostume.brand3_mesh);
			part_brand_3.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.brand_texture];
		}
		if (myCostume.brand4_mesh.Length > 0)
		{
			part_brand_4 = GenerateCloth(reference, "Character/" + myCostume.brand4_mesh);
			part_brand_4.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.brand_texture];
		}
		part_head.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.skin_texture];
		part_chest.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.skin_texture];
	}
	...
	public void setFacialTexture(GameObject go, int id)
	{
		if (id >= 0)
		{
			go.GetComponent<Renderer>().material = CharacterMaterials.materials[myCostume.face_texture];
			float num = 0.125f;
