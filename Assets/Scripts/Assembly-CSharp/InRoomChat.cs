				...
				else
				{
					...
					else if (inputLine == "/p1")
					{
						if (Portal1Num == 0)
						{
							...
							Portal1GO.transform.position = Camera.main.transform.position + Portalcameraoffset;
							Portal1Num = 1;
					...
					else if (inputLine == "/trampoline")
					{
						...
						for (int m = 0; m < 30; m++)
						{
							...
							gameObject.transform.position = Camera.main.transform.position + vector;
						}
						...
						gameObject2.transform.position = Camera.main.transform.position + trampolineoffset;
					...
					else if (inputLine == "/p2")
					{
						if (Portal2Num == 0)
						{
							...
							Portal2GO.transform.position = Camera.main.transform.position + Portalcameraoffset;
