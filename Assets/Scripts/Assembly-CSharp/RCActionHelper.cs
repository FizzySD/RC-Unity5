			...
			if (photonPlayer != null)
			{
				...
				case 17:
				{
					...
					if (FengGameManagerMKII.heroHash.ContainsKey(iD))
					{
						...
						return nextHelper.returnBool(hERO.GetComponent<UnityEngine.Rigidbody>().velocity.magnitude);
					}
					return false;
				}
				}
		...
		case 2:
		{
			...
			if (photonPlayer != null)
			{
				...
				case 17:
				{
					...
					{
						HERO hERO = (HERO)FengGameManagerMKII.heroHash[iD];
						return nextHelper.returnInt(hERO.GetComponent<UnityEngine.Rigidbody>().velocity.magnitude);
					}
					return 0;
				}
				}
		...
		case 2:
		{
			...
			if (photonPlayer != null)
			{
				...
				case 17:
				{
					...
					{
						HERO hERO = (HERO)FengGameManagerMKII.heroHash[iD];
						return nextHelper.returnString(hERO.GetComponent<UnityEngine.Rigidbody>().velocity.magnitude);
					}
					return string.Empty;
				}
				}
