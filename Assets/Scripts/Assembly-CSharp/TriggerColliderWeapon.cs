...
public class TriggerColliderWeapon : MonoBehaviour
{
	...
	private void napeMeat(Vector3 vkill, Transform titan)
	{
		...
		gameObject.GetComponent<Rigidbody>().AddForce(vkill.normalized * 15f, ForceMode.Impulse);
		gameObject.GetComponent<Rigidbody>().AddForce(-titan.forward * 10f, ForceMode.Impulse);
		gameObject.GetComponent<Rigidbody>().AddTorque(new Vector3(Random.Range(-100, 100), Random.Range(-100, 100), Random.Range(-100, 100)), ForceMode.Impulse);
	}
	...
	private void OnTriggerStay(Collider other)
	{
		...
		else if (other.gameObject.tag == "titanneck")
		{
			...
			if (IN_GAME_MAIN_CAMERA.gametype == GAMETYPE.SINGLE)
			{
				...
				{
					int b2 = (int)((component.GetComponent<Rigidbody>().velocity - component4.transform.root.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
					b2 = Mathf.Max(10, b2);
					...
					component5.die();
					napeMeat(currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.GetComponent<Rigidbody>().velocity, component4.transform.root);
			...
			else if (!PhotonNetwork.isMasterClient)
			{
				if (component5 != null)
				{
					...
					{
						int b3 = (int)((component.GetComponent<Rigidbody>().velocity - component4.transform.root.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
						b3 = Mathf.Max(10, b3);
						if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
						{
				...
				else if (component4.transform.root.GetComponent<FEMALE_TITAN>() != null)
				{
					...
					int b4 = (int)((currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.GetComponent<Rigidbody>().velocity - component4.transform.root.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
					b4 = Mathf.Max(10, b4);
				...
				else if (component4.transform.root.GetComponent<COLOSSAL_TITAN>() != null)
				{
					...
					{
						int b5 = (int)((currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.GetComponent<Rigidbody>().velocity - component4.transform.root.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
						b5 = Mathf.Max(10, b5);
			...
			else if (component5 != null)
			{
				if (!component5.hasDie)
				{
					int b6 = (int)((component.GetComponent<Rigidbody>().velocity - component4.transform.root.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
					b6 = Mathf.Max(10, b6);
					if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
					{
			...
			else if (component4.transform.root.GetComponent<FEMALE_TITAN>() != null)
			{
				...
				if (!component4.transform.root.GetComponent<FEMALE_TITAN>().hasDie)
				{
					int b7 = (int)((currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.GetComponent<Rigidbody>().velocity - component4.transform.root.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
					b7 = Mathf.Max(10, b7);
					if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
					{
			...
			else if (component4.transform.root.GetComponent<COLOSSAL_TITAN>() != null)
			{
				...
				if (!component4.transform.root.GetComponent<COLOSSAL_TITAN>().hasDie)
				{
					int b8 = (int)((currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.GetComponent<Rigidbody>().velocity - component4.transform.root.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
					b8 = Mathf.Max(10, b8);
					if (SettingsManager.GeneralSettings.SnapshotsEnabled.Value)
					{
		...
		else
		{
			...
			int b9 = (int)((currentCamera.GetComponent<IN_GAME_MAIN_CAMERA>().main_object.GetComponent<Rigidbody>().velocity - gameObject3.GetComponent<Rigidbody>().velocity).magnitude * 10f * scoreMulti);
			b9 = Mathf.Max(10, b9);
